...
class AvatarStylizer(QWidget):
    ...
    def initUI(self):
        ...
        self.model_choice.addItems(["ArtStyle","stable-diffusion-v1-5","majicMIX realistic","darkSushiMixMix_225D"])
    ...
    def update_image(self,image):
            ...
            qt_image = qt_image.scaled(self.image_label.size(), Qt.KeepAspectRatio, Qt.SmoothTransformation)
